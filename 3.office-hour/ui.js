        ...
        <div class="card card-body mb-3">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <a href="${user.html_url}" class="btn btn-primary"></a>
                </div>
                <div class="col-md-9">
    ...
    showRepos(repos) {
        repos. forEach (function (repo) {
            ...
            <div class="card card-body mb-2">
                ...
                <span class-"badge badge-primary"›Stars: ${repo. stargazers_count}</span> <span class="badge badge-secondary">Watchers: ${repo.watchers_count}</span> 
